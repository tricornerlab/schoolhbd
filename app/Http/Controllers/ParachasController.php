...
class ParachasController extends Controller
{
    ...
    {
        $text = \DB::table('parachas')->paginate(2);
        return view('layouts.default.parachas')->with([
            'text' => $text,
     ...
     *
     * @param  \App\Models\Paracha  $paracha
     * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View
     */
    public function show(Paracha $paracha)
    {
        $text = Paracha::where('id', $paracha->id)->get();

        return view('layouts.default.paracha')->with([
            'text' => $text,
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Paracha $paracha)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Paracha $paracha)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Paracha $paracha)
    {
        //
    }
}
