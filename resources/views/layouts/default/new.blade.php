...
{{--                                        LIKES--}}
                                        <form action ="{{ route('nlike') }}" method="GET">
                                            <input class="hidden" name="id" value="{{ $item[0]->id }}"/>
                                            <button type="submit" name="" >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up ml-4 " viewBox="0 0 16 16">
                                        ...
                                        <p class="pr-4 ml-1">{{$item[0]->likes}}</p>
